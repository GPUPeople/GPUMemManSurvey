...
def main():
	...
	if(args.t):
		...
		if any("h" in s for s in args.t):
			testcases["Halloc"] = build_path + str("h_mixed_alloc_test")
		...
		if any("r" in s for s in args.t):
			testcases["RegEff-A"] = build_path + str("r_mixed_alloc_test_a")
			testcases["RegEff-AW"] = build_path + str("r_mixed_alloc_test_aw")
			# testcases["RegEff-C"] = build_path + str("r_mixed_alloc_test_c")
			testcases["RegEff-CF"] = build_path + str("r_mixed_alloc_test_cf")
			# testcases["RegEff-CM"] = build_path + str("r_mixed_alloc_test_cm")
			testcases["RegEff-CFM"] = build_path + str("r_mixed_alloc_test_cfm")
